    ...
    return(
        <div className="about">
            ...
            <div className="content">
                ...
                <p>Olá, meu nome é Gabriel Neto, e sou apaixonado por tecnologia. Minha trajetória até aqui foi marcada por uma série de decisões e acontecimentos que moldaram meu caminho profissional e pessoal.<br/><br/>
                ...
                Sinta-se à vontade para explorar meus projetos e entrar em contato. Estou ansioso para colaborar e fazer a diferença através da tecnologia.</p><br/><br/>
            </div>
        </div>
    );
}